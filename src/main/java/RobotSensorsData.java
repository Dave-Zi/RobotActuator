...
class RobotSensorsData {
    ...
    // from given json
    Map<String, Map<String, Map<String, Double>>> jsonToBoardsMap(String json) {
    ...
    void setPortValue(String boardName, String boardIndex, String portName, Double newValue) {
        Map<String, Double> ports = getPorts(boardName, boardIndex);
        ports.replace(portName, newValue);
    }

    Double getPortValue(String boardName, String boardIndex, String portName) {
        Map<String, Double> ports = getPorts(boardName, boardIndex);
        return ports.get(portName);
    }

    Map<String, Map<String, Map<String, Double>>> getPortsMap() {
        return portsMap;
    }
